...
ace_cookoff_probabilityCoef = 0.1;
...
ace_medical_bleedingCoefficient = 0;
ace_medical_blood_enabledFor = 0;
...
ace_medical_level = 1;
ace_medical_litterCleanUpDelay = 120;
ace_medical_litterSimulationDetail = 2;
force ace_medical_maxReviveTime = 0;
...
ace_switchunits_enableSwitchUnits = true;
ace_switchunits_safeZoneRadius = 100;
ace_switchunits_switchToCivilian = true;
